...
func PrettyPrintConfig() string {
	return fmt.Sprintf(
		"VIGIA_GER_HOST: %s, VIGIA_GER_SERVER_CONN: %s, VIGIA_GER_SERVER_PORT: %d, VIGIA_GRAV_HOST: %s, VIGIA_GRAV_CONN: %s, VIGIA_GRAV_PORT: %d, VIGIA_DB_HOST: %s, VIGIA_DB_USER: %s, VIGIA_DB_PASSWORD: %s, VIGIA_DB_NAME: %s, VIGIA_DB_MAXIDLECONNS: %d, VIGIA_DB_MAXOPENCONNS: %d, VIGIA_DB_SSLMODE: %s",
		viper.GetString("VIGIA_GER_HOST"),
		viper.GetString("VIGIA_GER_SERVER_CONN"),
		viper.GetInt("VIGIA_GER_SERVER_PORT"),
		viper.GetString("VIGIA_GRAV_HOST"),
		viper.GetString("VIGIA_GRAV_CONN"),
		viper.GetInt("VIGIA_GRAV_PORT"),
