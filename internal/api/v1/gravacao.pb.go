...
type InfoServidorResp_Processo_StatusProcesso int32

const (
	InfoServidorResp_Processo_PARADO     InfoServidorResp_Processo_StatusProcesso = 0
	InfoServidorResp_Processo_EXECUTANDO InfoServidorResp_Processo_StatusProcesso = 1
)

// Enum value maps for InfoServidorResp_Processo_StatusProcesso.
var (
	InfoServidorResp_Processo_StatusProcesso_name = map[int32]string{
		0: "PARADO",
		1: "EXECUTANDO",
	}
	InfoServidorResp_Processo_StatusProcesso_value = map[string]int32{
		"PARADO":     0,
		"EXECUTANDO": 1,
	}
)

func (x InfoServidorResp_Processo_StatusProcesso) Enum() *InfoServidorResp_Processo_StatusProcesso {
	p := new(InfoServidorResp_Processo_StatusProcesso)
	*p = x
	return p
}

func (x InfoServidorResp_Processo_StatusProcesso) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (InfoServidorResp_Processo_StatusProcesso) Descriptor() protoreflect.EnumDescriptor {
	return file_gravacao_proto_enumTypes[0].Descriptor()
}

func (InfoServidorResp_Processo_StatusProcesso) Type() protoreflect.EnumType {
	return &file_gravacao_proto_enumTypes[0]
}

func (x InfoServidorResp_Processo_StatusProcesso) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use InfoServidorResp_Processo_StatusProcesso.Descriptor instead.
func (InfoServidorResp_Processo_StatusProcesso) EnumDescriptor() ([]byte, []int) {
...
type InfoServidorReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *InfoServidorReq) Reset() {
	*x = InfoServidorReq{}
...
func (x *InfoServidorReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InfoServidorReq) ProtoMessage() {}

func (x *InfoServidorReq) ProtoReflect() protoreflect.Message {
	mi := &file_gravacao_proto_msgTypes[0]
...
// Deprecated: Use InfoServidorReq.ProtoReflect.Descriptor instead.
func (*InfoServidorReq) Descriptor() ([]byte, []int) {
	return file_gravacao_proto_rawDescGZIP(), []int{0}
}

type InfoServidorResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Processos []*InfoServidorResp_Processo `protobuf:"bytes,1,rep,name=processos,proto3" json:"processos,omitempty"`
}

func (x *InfoServidorResp) Reset() {
	*x = InfoServidorResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *InfoServidorResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InfoServidorResp) ProtoMessage() {}

func (x *InfoServidorResp) ProtoReflect() protoreflect.Message {
	mi := &file_gravacao_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InfoServidorResp.ProtoReflect.Descriptor instead.
func (*InfoServidorResp) Descriptor() ([]byte, []int) {
	return file_gravacao_proto_rawDescGZIP(), []int{1}
}

func (x *InfoServidorResp) GetProcessos() []*InfoServidorResp_Processo {
	if x != nil {
		return x.Processos
	}
	return nil
...
type ConfigurarProcessoReq struct {
	...
	ProcessoId         int32                      `protobuf:"varint,2,opt,name=processo_id,json=processoId,proto3" json:"processo_id,omitempty"`
...
func (x *ConfigurarProcessoReq) GetProcessoId() int32 {
	if x != nil {
		return x.ProcessoId
	}
	return 0
...
type InfoServidorResp_Processo struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ProcessoId         int32                                    `protobuf:"varint,1,opt,name=processo_id,json=processoId,proto3" json:"processo_id,omitempty"`
	...
	StatusProcesso     InfoServidorResp_Processo_StatusProcesso `protobuf:"varint,4,opt,name=status_processo,json=statusProcesso,proto3,enum=gravacao.InfoServidorResp_Processo_StatusProcesso" json:"status_processo,omitempty"`
}

func (x *InfoServidorResp_Processo) Reset() {
	*x = InfoServidorResp_Processo{}
	if protoimpl.UnsafeEnabled {
...
func (x *InfoServidorResp_Processo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InfoServidorResp_Processo) ProtoMessage() {}

func (x *InfoServidorResp_Processo) ProtoReflect() protoreflect.Message {
	mi := &file_gravacao_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InfoServidorResp_Processo.ProtoReflect.Descriptor instead.
func (*InfoServidorResp_Processo) Descriptor() ([]byte, []int) {
	return file_gravacao_proto_rawDescGZIP(), []int{1, 0}
}

func (x *InfoServidorResp_Processo) GetProcessoId() int32 {
	if x != nil {
		return x.ProcessoId
	}
	return 0
...
func (x *InfoServidorResp_Processo) GetCameraId() int32 {
	if x != nil {
		return x.CameraId
	}
	return 0
...
func (x *InfoServidorResp_Processo) GetProcessadorCaminho() string {
	if x != nil {
		return x.ProcessadorCaminho
	}
	return ""
...
func (x *InfoServidorResp_Processo) GetStatusProcesso() InfoServidorResp_Processo_StatusProcesso {
	if x != nil {
		return x.StatusProcesso
	}
	return InfoServidorResp_Processo_PARADO
}
...
var file_gravacao_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x49, 0x4e, 0x46, 0x4f, 0x10, 0x04, 0x22, 0x9c, 0x01, 0x0a, 0x16, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	...
	,
...
var file_gravacao_proto_goTypes = []interface{}{
	(InfoServidorResp_Processo_StatusProcesso)(0), // 0: gravacao.InfoServidorResp.Processo.StatusProcesso
	...
	(*InfoServidorReq)(nil),                       // 3: gravacao.InfoServidorReq
	(*InfoServidorResp)(nil),                      // 4: gravacao.InfoServidorResp
	(*ConfigurarProcessoReq)(nil),                 // 5: gravacao.ConfigurarProcessoReq
	(*ConfigurarProcessoResp)(nil),                // 6: gravacao.ConfigurarProcessoResp
	(*InfoServidorResp_Processo)(nil),             // 7: gravacao.InfoServidorResp.Processo
}
var file_gravacao_proto_depIdxs = []int32{
	7, // 0: gravacao.InfoServidorResp.processos:type_name -> gravacao.InfoServidorResp.Processo
	...
	0, // 3: gravacao.InfoServidorResp.Processo.status_processo:type_name -> gravacao.InfoServidorResp.Processo.StatusProcesso
	3, // 4: gravacao.Gravacao.InfoServidor:input_type -> gravacao.InfoServidorReq
	5, // 5: gravacao.Gravacao.ConfigurarProcesso:input_type -> gravacao.ConfigurarProcessoReq
	4, // 6: gravacao.Gravacao.InfoServidor:output_type -> gravacao.InfoServidorResp
...
func file_gravacao_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_gravacao_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InfoServidorResp_Processo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
